    ...
    <div class="main-bod">
        <section class="header-section">
            <div class="container header-container">
                ...
                <div class="code-box">
                    <img src="../assets/images/code.png" alt="code" class="code">
                </div>
            </div>
        </section>
        ...
        <div class="main-container">
            <div class="text-container">
                <h1>Built-in Compiler </h1>
                <h2>Code, check, and run instantly with <br> our built-in compiler  your code <br> playground on the go!</h2>
            </div>
            <div class="image-container">
                <img src="../assets/images/run.png" alt="Placeholder Image">
            </div>
        </div>
