              ...
              <div class="container-fluid">
                  <div class="collapse navbar-collapse">
                      <ul class="navbar-nav">
                          ...
                          <li class="nav-item"><a class="nav-link" href="excercise-category.html">Exercises</a></li>
  ...
  <div class="nav-buttons d-flex flex-column align-items-center mt-3">
    <button class="btn btn-logout mt-2" id="logout">Logout</button>
              ...
              <ul class="navbar-nav1 mt-4">
                  ...
                  <li class="nav-item1"><a class="nav-link1" href="excercise-category.html">Exercises</a></li>
  ...
  <a href="https://www.instagram.com/skillstackwebsite/profilecard/">
    ...
    >
      ...
      <div class="navbar">
        ...
        <a href="excercise-category.html">Exercises</a>
